<template>
	<view class="forget">
		<cu-custom bgColor="bg-white" :isBack="true">
			<block slot="backText" ><navigator url="login"><text class="text-lg">忘记密码</text></navigator></block>
		...
		<view class="content marin-top" style="margin-top: 100upx;">
			...
			<view class="cu-form-group ">
				...
				<input placeholder="点击输入收到的验证码" name="input"></input>
				<button class='cu-btn bg-blue shadow' @click="">{{verCodeText}}</button>
			</view>
			<view class="cu-form-group ">
