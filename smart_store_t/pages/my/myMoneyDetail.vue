			...
			<view class="padding  ">
				<view class="padding-lr bg-white margin-top">
					<view class="solid-bottom padding text-center">
						<text class="text-price text-xl">80.00</text>
					</view>
					<view  >
						<text class="text-black text-xl">2020-5-3  小海小鲜（000001）</text>
					</view>
					<view  >
						<text class="text-gray text-sm">安装费           +100.00</text>
					</view>
					<view  >
						<text class="text-gray text-sm">市场提成        +100.00</text>
					</view>
					<view  >
						<text class="text-gray text-sm">保险提成           +100.00</text>
					</view>
					<view >
						<text class="text-gray text-sm">新增设备提成           +100.00</text>
					</view>
				</view>
				<view class="padding-lr bg-white margin-top">
					<view class="solid-bottom padding text-center">
						<text class="text-price text-xl">90.00</text>
					</view>
					<view  >
						<text class="text-black text-xl">2020-5-3  小海小鲜（000001）</text>
					</view>
				...
				<view class="padding-lr bg-white margin-top">
					<view class="solid-bottom padding text-center">
						<text class="text-price text-xl">100.00</text>
					</view>
					<view  >
						<text class="text-black text-xl">2020-5-3  小海小鲜（000001）</text>
					</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			gotoDetail(){
				uni.navigateTo({
					url:  'devicesDetail?detailflag=1'
				})
			},
			gotoAdd(){
				debugger
