	...
	<view class="page-box">
		...
		<view class="content-box">
			<view>
				...
				<textarea class="textarea" v-model="value" placeholder="维修说明......" placeholder-class="input-placeholder" maxlength="100"
			...
			<view class="btn-box">
				<button class="form-submit-btn" type="primary">确认</button>
			</view>
		</view>
	</view>
</template>
